...
<form action='' method="post">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="subject" placeholder="sujet" name="subject" value='<?= $formulaire->getSubject() ?>'>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="Textarea" name='Textarea' rows="3" value='<?= $formulaire->getTextarea() ?>'></textarea>
    </div>
